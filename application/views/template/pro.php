...
<!-- You are already be our Premium user		 -->
...
function initPayPalButton() {
    ...
    createOrder: function(data, actions) {
        ...
        purchase_units: [{"description":"Pro level ","amount":{"currency_code":"USD","value":0.01}}]
        });
    },
    ...
    onApprove: function(data, actions) {
        ...
        // window.location.href = 'https://infs3202-053734f9.uqcloud.net/rainbow/profile/update_membership/Pro';
